    ...
    pub fn as_vec_u32(&self) -> Vec<u32> {
        match self {
            Self::All => Self::Alphalow
                .as_vec_u32()
                .into_iter()
                .chain(Self::Alphaup.as_vec_u32().into_iter())
                .chain(Self::AlphaNum.as_vec_u32().into_iter())
                .chain(Self::Arrow.as_vec_u32().into_iter())
                .chain(Self::Bin.as_vec_u32().into_iter())
                .chain(Self::Cards.as_vec_u32().into_iter())
                .chain(Self::Clock.as_vec_u32().into_iter())
                .chain(Self::Crab.as_vec_u32().into_iter())
                .chain(Self::Dominosh.as_vec_u32().into_iter())
                .chain(Self::Dominosv.as_vec_u32().into_iter())
                .chain(Self::Earth.as_vec_u32().into_iter())
                .chain(Self::Emojis.as_vec_u32().into_iter())
                .chain(Self::Jap.as_vec_u32().into_iter())
                .chain(Self::LargeLetters.as_vec_u32().into_iter())
                .chain(Self::Moon.as_vec_u32().into_iter())
                .chain(Self::Num.as_vec_u32().into_iter())
                .chain(Self::NumberedBalls.as_vec_u32().into_iter())
                .chain(Self::NumberedCubes.as_vec_u32().into_iter())
                .chain(Self::Plants.as_vec_u32().into_iter())
                .chain(Self::Smile.as_vec_u32().into_iter())
                .chain(Self::Shapes.as_vec_u32().into_iter())
                .collect(),
